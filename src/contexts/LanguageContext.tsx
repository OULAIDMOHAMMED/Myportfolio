...
const translations = {
  fr: {
    ...
    "contact.seeking": "Je recherche activement un stage de fin d'études (PFE) en tant que développeur Full-Stack.",
  ...
  en: {
    ...
    "contact.seeking": "I'm actively looking for an end-of-studies internship (PFE) as a Full-Stack developer.",
